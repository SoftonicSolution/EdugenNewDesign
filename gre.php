...
<div class="col-lg-2 col-md-2">
    <img src="images/GRE.png" style="box-shadow:  0 0 20px 0 #ddebec ;padding:12%; border-radius:5px; background-color:white; width:100%; margin-top:15%;" id="GMATimage">
</div>
<div class="col-lg-8 col-md-8">
  ...
  <a href="#home" class="active" id="FAST-FACTS">ABOUT GRE</a>
  <a href="#Basics" id="WHY">GRE BASICS</a>
    ...
    <div class="row">
      ...
      <div class="card" style=" background-color:#ddebec; height:92%; text-align:center; " id="GDP2">
       <p class="card-text" style="font-size:1.rem; font-weight:600; padding-top:4%; color: #267871;">Acroynm</p>
        <p style="font-size:0.9rem;font-weight:400; color:#000000; margin-top: -5%;" id="PG">GRE</p>
    </div>
      </div>
      <div class="col-lg-2 col-md-2 col-12" id="type">
      <div class="card" style=" background-color:#ddebec; height:92%; text-align:center; " id="GDP2">
...
<section style="margin-top: 2%;" id="Basics">
  <div class="container">
    ...
    <h2 style="color: #267871; font-size:2.5rem; font-weight:600;">About GRE</h2>
    </div>
    </div>
    <div class="row" style="margin-top: 2%;">
      <div class="col-lg-9 col-md-9 col-12">
     <h2 style="color:#656060; font-size:2rem; font-weight:600;">About Test</h2>
     <p style="color:#69696f; font-size:1.2rem; font-weight:200;">The Graduate Management Admission Test, or GRE, is an important part of the business school application process. The GM
...
<section style="margin-top: 2%;">
  ...
  <div class="row">
  <div class="col-lg-9 col-md-9 col-12">
    <h2 style="color: #267871; font-size:2.2rem; font-weight:600;">GRE Basics</h2>
    </div>
  </div>
    <div class="row" style="margin-top: 2%;">
      <div class="col-lg-9 col-md-9 col-12">
...
<h2 style="color:#656060; font-size:1.8rem; font-weight:600; ">General Facts</h2></div>
  <div class="container" style="background-color:#ddebec; padding:2%; border-radius:5px;">
    ...
    <span style="color:#656060; font-size:1rem;font-weight:500; ">GRE is conducted throughout the year. You can take the GRE once every 16 days, up to five times within any continuous rolling 12-month period (365 days) and up to a total of eight times.</span>
    </div>
    </div>
    <div class="row">
    <div class="col-lg-3 col-md-3 col-12">
    ...
    <div class="col-lg-9 col-md-9 col-12" style="margin-top: 1%;">
    <span style="color:#656060; font-size:1rem;font-weight:500; ">The GRE exam is offered on demand and year-round at 34 cities in India through 39 test centres.</span>
    </div>
    </div>
    <div class="row">
    <div class="col-lg-3 col-md-3 col-12">
    ...
    <div class="col-lg-9 col-md-9 col-12" style="margin-top: 1%;">
    <span style="color:#656060; font-size:1rem;font-weight:500; ">You can check your Official Score Report within 20 days of the Exam Date on the official website of GMAC. A unique link will be sent to your email ID given at the time of registration which will assist you on how to access the GRE Score Report.</span>
    </div>
    </div>
...
<div class="col-lg-3 col-md-3 col-12"  id="GMATcard">
    ...
    <div class="col-lg-3 col-md-3 col-12"  id="GMATcard">
       ...
       <p class="m-2"  style=" color: #000000; font-size:0.8rem; font-weight:400;">   The GRE Quantitative section is designed to test your content and analytical knowledge of basic math concepts, including arithmetic, algebra, and geometry. It consists of 14-15 Data Sufficiency and 16-19 Problem solving questions. </p>
		 </div>
	  </div>
    <div class="col-lg-3 col-md-3 col-12"  id="GMATcard">
       <div class="box" style="height: 360px; width:100%"  id="GDP">
...
<div class="row">
<div class="col-lg-12 col-md-12 col-12">
<p style="color:#69696f; font-size:1.2rem; font-weight:200;">GRE registration can be done both online on the official website and offline on phone or by mail. If you are applying through phone, then call the GRE Customer Service in your region which will be charging you an additional fee of US$ 10 whereas postal mail provides an option to apply via check or money order.</p>
</div>
</div>
</div>
<div class="container">
...
<img src="images/step1.png">
    ...
    <span style="color:#656060; font-size:1rem;font-weight:500; ">Signup on GRE official portal</span>
    </div>
  </div>
  <div class="row">
...
<span style="font-size: 1.2rem;" id="Admission">Confused About How To Apply To GRE?</span>
  ...
  <div class="row"  style="margin-top: 2%;">
    ...
    <div class="box" style="height: 400px; width:95%">
		  <img src="images/card2.jpg" 
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1.2rem; font-weight:600;">CAT vs GRE</h2>
       <p class="m-2"  style=" color: #000000; font-size:1rem; font-weight:400;"> CAT vs GRE is one of the biggest dilemmas for students who are aspiring to pursue Management education… The post CAT vs GRE appeared first on Leverage Edu.</p>
    <a href="#" style="font-size:1rem; font-weight:600;">Read Now
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		 </div>
    </div>
    ...
    <div class="box" style="height: 400px; width:95%">
		  <img src="images/card3.jpg" 
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1.2rem; font-weight:600;">What is the Importance of GRE Scores?</h2>
       <p class="m-2"  style=" color: #000000; font-size:1rem; font-weight:400;"> GRE is definitely one of the toughest exams to crack but have you ever wondered why it gained… The post What is the Importance of GRE Scores? appeared first on Leverage Edu.</p>
    <a href="#" style="font-size:1rem; font-weight:600;">Read Now
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		 </div>
    </div>
  ...
  <div class="row"  style="margin-top: 2%;"  id="FAQs">
    ...
    <div class="box" style="height: 400px; width:95%">
		  <img src="images/card4.jpg" 
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1.2rem; font-weight:600;">Leverage Edu’s GRE Success Stories</h2>
       <p class="m-2"  style=" color: #000000; font-size:1rem; font-weight:400;"> Every one of the greatest leaders in the world suffered failures before being popular. While we all applaud… The post Leverage Edu’s GRE Success Stories appeared first on Leverage Edu. </p>
    <a href="#" style="font-size:1rem; font-weight:600;">Read Now
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		 </div>
    </div>
    ...
    <div class="box" style="height: 400px; width:95%">
		  <img src="images/card5.jpg" 
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1.2rem; font-weight:600;">Top B-Schools in India Accepting GRE Scores</h2>
       <p class="m-2"  style=" color: #000000; font-size:1rem; font-weight:400;">The Graduate Management aptitude test or GRE is a computer adaptive examination that assesses the writing, analytical, verbal… The post Top B-Schools in India Accepting GRE Scores appeared first on Leverage Edu.</p>
    <a href="#" style="font-size:1rem; font-weight:600;">Read Now
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		 </div>
    </div>
    ...
    <div class="box" style="height: 400px; width:95%" >
		  <img src="images/card6.jpg" 
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1.2rem; font-weight:600;" id="Collleges">IELTS and GRE Scores to Study in UK</h2>
       <p class="m-2"  style=" color: #000000; font-size:1rem; font-weight:400;"> Home to the British Royal Family, the UK has always been a prominent study destination as it is… The post IELTS and GRE Scores to Study in UK appeared first on Leverage Edu.</p>
    <a href="#" style="font-size:1rem; font-weight:600;">Read Now
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		 </div>
    </div>
...
<div class="container" style="margin-top: 3%;"  >
  ...
  <a href="gretips.php"><button type="button" class="btn btn-dark" style="margin-left: 40%; border-radius:20px; font-size:1.2rem;" id="see">See All Preparation Tips</button></a>
  </div>
  </div>
</div>
