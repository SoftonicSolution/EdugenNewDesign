    ...
    n.extend(p.prototype, {
        ...
        o.removeEvents(),
          ...
          s.on("orientationchange.fb resize.fb", function (t) {
            t && t.originalEvent && "resize" === t.originalEvent.type
              ...
              : (o.$refs.stage.hide(),
                setTimeout(function () {
                  o.$refs.stage.showWindow(), o.update();
                }, 600));
          }),
      ...
      hideControls: function () {
        (this.isHiddenControls = !0),
          this.$refs.container.removeClass(
            "fancybox-showWindow-infobar fancybox-showWindow-toolbar fancybox-showWindow-caption fancybox-showWindow-nav"
          );
      },
      showControls: function () {
        ...
        (t.isHiddenControls = !1),
          ...
          n
            .toggleClass(
              "fancybox-showWindow-toolbar",
              !(!e.toolbar || !e.buttons)
            )
            .toggleClass(
              "fancybox-showWindow-infobar",
              !!(e.infobar && t.group.length > 1)
            )
            .toggleClass(
              "fancybox-showWindow-nav",
              !!(e.arrows && t.group.length > 1)
            )
            .toggleClass("fancybox-is-modal", !!e.modal),
          t.$caption
            ? n.addClass("fancybox-showWindow-caption ")
            : n.removeClass("fancybox-showWindow-caption");
      },
      ...
      init: function (t) {
        ...
        (e.opts = t.group[t.currIndex].opts.thumbs),
          ...
          ("image" == o.type || o.opts.thumb || o.opts.$thumb)
            ? (e.$button.showWindow().on("click", function () {
                e.toggle();
              }),
              (e.isActive = !0))
            : e.$button.hide();
      ...
      e(t).on({
        "onInit.fb": function (t, e) {
          ...
          e &&
            !e.Thumbs &&
            ((o = new n(e)),
            o.isActive && o.opts.autoStart === !0 && o.showWindow());
        },
        "beforeShow.fb": function (t, e, n, o) {
          var i = e && e.Thumbs;
