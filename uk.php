...
<h2 style="font-size: 2.4rem; text-align:center; color:#1731ea; font-weight:bold;  padding-top:12%; " id="textsmall"> Study in UK</h2>
<img src="images/UK.png" style="width:6%; height:6%; margin-left: 35%; margin-top: -7%;" id="smalllogo">
...
<div class="container">
    ...
    <h2 style="font-size: 2rem; text-align:left; color:#000000; font-weight:500; "> Why study in UK?</h2>    
    ...
    As compared to the UK and the UK, the cost of living in Australia is much lower and much affordable. In addition to this the current Australian immigration laws allow international students to work part-time up to a certain number of hours per
     week with a good pay, which makes it a preferred choice over UK and UK</p>
        </div>
        </div>
    </div>
    ...
    <div class="carousel-item active">
     <div class="row">
	  ...
	  <div class="col-lg-4 col-md-4 col-12">
       ...
       <h2 style="color: #000000;font-size:1rem; font-weight:600;">MD in UK</h2>
    ...
    <div class="carousel-item">
	  ...
	  <div class="col-lg-4 col-md-4 col-12">
	     <div class="box" style="height: 356px; width:95%">
		   ...
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1rem; font-weight:600;">Cost of MBA in UK</h2>
       <span style="color: #000000; font-size:0.9rem;  font-weight:200;">5 mins read</span>
    ...
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		...
		<div class="col-lg-4 col-md-4 col-12">
	     <div class="box" style="height: 356px; width:95%">
		   ...
		   class="img-thumbnail" id="boximg">  
		   <h2 style="color: #000000;font-size:1rem; font-weight:600;">Best Medical Colleges in UK</h2>
       <span style="color: #000000; font-size:0.9rem;  font-weight:200;">5 mins read</span>
    ...
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		...
		<div class="col-lg-4 col-md-4 col-12">
	     <div class="box" style="height: 356px; width:95%">
		   ...
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1rem; font-weight:600;">Masters in UK</h2>
       <span style="color: #000000; font-size:0.9rem;  font-weight:200;">5 mins read</span>
		   <p class="m-2"  style=" color: #000000; font-size:0.8rem; font-weight:400;"> With an image of being one of the most developed nations in the world, the UK has conceiv... </p>
    <a href="#" style="font-size:1rem;  font-weight:600;">Read Now
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;"></i></a>
		 </div>
	  </div>
    ...
    <div class="carousel-item" >
	  ...
	  <div class="col-lg-4 col-md-4 col-12">
	     <div class="box" style="height: 356px; width:95%">
		   ...
		   class="img-thumbnail" id="boximg">  
       <h2 style="color: #000000;font-size:1rem; font-weight:600;">CMA UK</h2>
       <span style="color: #000000; font-size:0.9rem;  font-weight:200;">5 mins read</span>
		   <p class="m-2"  style=" color: #000000; font-size:0.8rem; font-weight:400;">  Are you exploring pathways to pursue CMA UK? Considered as one of the top-most courses in... </p>
    <a href="#" style="font-size:1rem; font-weight:600;">Read Now
    <i class="fa fa-arrow-right" style="font-size:1rem; font-weight:600;" ></i></a>
		 </div>
    </div>
...
<div class="container">
    ...
    <p  style="font-size: 1.1rem;  text-align:left!important; font-weight:400!important; color:gray; font-family: 'Montserrat', sans-serif!important;">
    A total of 1095299 international students enrolled in 4512 higher education institutions in UK across various courses. The major highlights are shown below</p>
 </div>
        </div>
    </div>
    <div class="container">
...
<div class="container">
  <div class="row">
    <h3 style="font-size: 1.2rem; font-weight:600; padding:2%;  width:100%">Popular Fields of Study in UK</h3>
...
<h3 style="font-size: 1.5rem; padding-bottom:5px;">Top Universities in UK</h3>
  <!-- Indicators -->
  <ul class="carousel-indicators">
...
<span style="font-size: 1.2rem;" id="Admission">Get Guidance On Studying In UK From Our Experts</span>
